[
  ...
  },
  {
    ...
    "enabled": "O",
    "trigger_definition": "CREATE TRIGGER trigger_purchase_order_create_vendor_bill AFTER INSERT ON purchase_orders FOR EACH ROW EXECUTE FUNCTION handle_purchase_order_vendor_bill()"
  },
  {
    ...
    "function_name": "handle_purchase_order_vendor_bill",
    "enabled": "O",
    "trigger_definition": "CREATE TRIGGER trigger_purchase_order_update_vendor_bill AFTER UPDATE OF total ON purchase_orders FOR EACH ROW WHEN (old.total IS DISTINCT FROM new.total) EXECUTE FUNCTION handle_purchase_order_vendor_bill()"
  },
  {
