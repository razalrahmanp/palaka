...
import { PlusCircle, Edit, Trash2, Wrench, Clock, CheckCircle, TrendingUp, Building2, Factory } from 'lucide-react';
...
import { AlRamsDashboard } from '@/components/manufacturing/AlRamsDashboard';
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-white/20 shadow-xl p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">Manage production jobs and track Al Rams operations</p>
          </div>
        </div>
      </div>
        ...
        <CardContent className="p-0">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200 px-6 pt-6">
              <TabsList className="grid w-full grid-cols-2 h-12 bg-white/50 backdrop-blur-sm">
                <TabsTrigger 
                  value="production" 
                  className="text-sm font-medium h-full data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:border-b-2 data-[state=active]:border-amber-500 transition-all duration-200"
                >
            ...
            <div className="p-6">
              ...
              <TabsContent value="al-rams" className="mt-0">
                <AlRamsDashboard />
              </TabsContent>
            </div>
          </Tabs>
