...
//   original_price?: number | null;
//   discount_amount?: number | null;
//   customers?: { name: string }[]; // Allow customers to be an array
// };
...
//   unit_price: number | null;
//   product_id?: string | null;
//   name?: string | null; // This is the product name
//   supplier_name?: string | null;
...
//     product_name: i.name, // Map 'name' column to 'product_name'
//     supplier_name: i.supplier_name,
//     products: null, // Will be fetched separately if needed
//   }));
